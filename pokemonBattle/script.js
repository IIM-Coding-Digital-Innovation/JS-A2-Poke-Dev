...
function search(query){
    ...
    .then(function(response){
        ...
        return pokemonStack= [response["name"],response["id"],response["sprites"]["front_default"],response["stats"]],pokemonfull=response;
    })
...
chooseModeButton.addEventListener("click",function(){
    if(!arcadeModeButton.classList.contains("active")){
        chooseModeButton.classList.toggle("active")
    }
   
})

arcadeModeButton.addEventListener("click",function(){
    if(!chooseModeButton.classList.contains("active")){
    arcadeModeButton.classList.toggle("active")
    }
})